        ...
        <div className="flex flex-col text-center">
          <div className="order-2 mt-12 md:order-1 md:mt-0">
            ...
            <p className="text-slate-body text-desktop-subheading mt-6 md:mt-[30px] max-w-[754px] m-auto">
              Never miss an event or a reminder again, thanks to an always-on,
              beautifully transparent calendar, sticking right on your desktop
              background wallpaper.
              <br />
              <br />
              Work with your local calendars and reminders, as well as your
              iCloud/Google/Outlook/any CalDAV calendars and reminders.
              <br />
              <br />
              Real-time update and customizable
            </p>
            <div className="mt-8">
              <a
                href="https://apps.apple.com/app/wallcal-wallpaper-calendar/id1581367286"
                target="_blank"
              ...
              <SetappButton />
              <link
                href="https://en.freedownloadmanager.org/styles/r2.css"
                rel="stylesheet"
              />{" "}
              <div
                id="fdm_aw_rec1"
                onClick={() => {
                  if (event.target.nodeName.toLowerCase() != "a") {
                    window.open(document.querySelector(".rg-rl").href);
                    return 0;
                  }
                }}
              >
                {" "}
                <div className="fdm_aw_rec1_linkName">
                  {" "}
                  <a
                    href="https://en.freedownloadmanager.org/Mac-OS/WallCal-FREE.html"
                    id="fdm_aw_rec1_linkName"
                    className="rg-rl rec1_short"
                    title="WallCal at Free Download Manager"
                    target="_blank noreferrer"
                  >
                    WallCal
                  </a>{" "}
                </div>{" "}
                <div className="fdm_aw_rec1_footer">
                  {" "}
                  <a
                    href="https://en.freedownloadmanager.org/"
                    target="_blank noreferrer"
                  >
                    Recommended on FDM
                  </a>{" "}
          ...
          >
            <div className="pt-4 md:pt-[60px] m-auto -mb-6 md:-mb-12">
              <Image
