    ...
    <div>
      <NextSeo
        ...
        openGraph={{
          ...
          type: "website",
          title:
            "WallCal -  Transparent calendar on desktop wallpaper for macOS",
          description:
            "Agendas/events/reminders on desktop wallpaper. Real-time update. Customizable.",
          images: [
            {
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content:
              "wallcal, calendar, desktop, wallpaper, blotter, background, schedule, reminder, event",
          },
        ]}
      />
          ...
          featureList={[
            [
              {
                ...
                description:
                  "Put WallCal anywhere you want on your desktop, or on your second monitor",
              },
              {
                icon: <CheckCircleIcon className="text-white" />,
                heading: "Frontmost state",
                description:
                  "Instantly bring WallCal to frontmost with a mouseclick, or a hotkey",
              },
              {
                icon: <CheckCircleIcon className="text-white" />,
            ...
            [
              ...
              },
              {
                ...
                description:
                  "Option to display only the calendar view, or the to-do list view",
              },
              {
                icon: <CheckCircleIcon className="text-white" />,
                heading: "Choose number of days to show",
                description:
                  "(Week view only) Option to display only today's agenda, or this week's days', or up to the next 7 days'",
              },
            ],
            [
              {
                ...
                description:
                  "(Week view only) Option to select the agenda's display time range (Default is 0:00 ~ 24:00)",
              },
              {
                icon: <CheckCircleIcon className="text-white" />,
                heading: "Customize color",
                description:
                  "Freely tweak the calendar's background color. Or make it 100% transparent. Your choice",
              },
              {
                icon: <CheckCircleIcon className="text-white" />,
                heading: "Multi-language support",
                description:
                  "WallCal supports 中文（🇨🇳）, 日本語（🇯🇵）, Deutsch（🇩🇪） besides English. More to come",
              },
            ],
          ]}
        />
